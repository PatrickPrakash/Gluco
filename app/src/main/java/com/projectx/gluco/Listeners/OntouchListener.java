...
public class OntouchListener implements RecyclerView.OnItemTouchListener {
    private ActivityFragment.ClickListener clicklistener;
    private GestureDetector gestureDetector;

    public OntouchListener(Context context, final RecyclerView recycleView, final ActivityFragment.ClickListener clicklistener) {
